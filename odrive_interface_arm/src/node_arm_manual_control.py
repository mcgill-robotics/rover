...
class ArmControlGUI(QWidget):
    ...
    def createMotorGroup(self, motorType, jointRanges):
        ...
        # self.fbLabel[0] = QLabel('Fb - Elbow: 0, Shoulder: 0, Waist: 0')

        # self.fbLabelBrushless.setAlignment(Qt.AlignCenter)
        # vbox.addWidget(self.fbLabelBrushless)
        return vbox
        # Brushless motor controls and feedback
    ...
    def updateFb(self, motorType, data):
        ...
        else:  # Assuming the else block is for 'Brushed'
