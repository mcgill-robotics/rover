...
class ArmControlGUI(QWidget):
    ...
    # Callback for the buttons next to the sliders, the slider itself already triggers the onChangeCmd
    # No need for manual call to onChangeCmd(joint), as the valueChanged signal will trigger it.
