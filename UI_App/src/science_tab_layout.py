...
class Ui_Science(QtWidgets.QWidget):
    def setupUi(self, Science):
        ...
        self.carousel_position_inc_spinbox.setSingleStep(0.1)
        ...
        self.gridLayout_7.addWidget(self.moisture_sampleCnt_label, 4, 1, 1, 1)
        self.moisture_plotter = QwtPlot(self.scrollAreaWidgetContents)
        brush = QtGui.QBrush(QtGui.QColor(0, 0, 0))
        brush.setStyle(QtCore.Qt.CrossPattern)
        self.moisture_plotter.setCanvasBackground(brush)
        self.moisture_plotter.setAutoReplot(False)
        ...
        self.gridLayout_7.addWidget(self.moisture_sampleCnt_spinbox, 5, 1, 1, 1)
